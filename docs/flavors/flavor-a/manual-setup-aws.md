...
## Setting up AWS EC2 instance for Rancher for Flavor A
...
5. In **Step 2: Choose an Instance Type**, For Flavor A, We went with t3a.medium because of the minimum requirement for Rancher  choose **Next: Configure Instance Details**.
...
1. Follow these steps but instead of rancher, it's for Flavor A. So change the tags from **rg-gw-dev: rancher** and **Name: rancher** to
